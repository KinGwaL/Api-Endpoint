...
app.post('/insert', function(req, res) {
    pg.connect(process.env.DATABASE_URL, function (err, conn, done) {
        ...
        conn.query(
            'INSERT INTO salesforce.Ruby_Survey__c (Full_Name__c, Position__c, Rating__c, Learnt1__c, Learnt2__c, Learnt3__c, suggest1__c, suggest2__c, suggest3__c) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)',
